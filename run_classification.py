...
vector_image = numpy.array(classification.load_poke_images('TrainingImages'))
vector_image2 = numpy.array(classification.load_poke_images2('TrainingImages'))
# print("shape of vector_image2:"+str(vector_image2.shape))

n_samples = len(vector_image)
# print(n_samples)
# print(vector_image)
data_image = vector_image.reshape((n_samples,-1))
# print("shape of vector_image:"+str(vector_image.shape))
# print("shape of data_image:"+str(data_image.shape))
#
# print(data_image)
vector_test_images = numpy.array(classification.load_poke_images('TestImages'))
...
# Fit the model
y_new = numpy.array(y).reshape((-1,1))
model.fit(vector_image,y_new,epochs=27)
y_pred = model.predict(vector_test_images)
